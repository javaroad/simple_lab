...
unparsefile = open(unparsedlog, 'a')
...
def slowspeed(line):
    ...
    #    pid = '1.101ts'
        ...
        pid = '102.10207'
    elif mpid == '0' and 'wasucn' in purlparseobj.path:
        pid = '102.10208'
    ...
    if pid == '3.304' and termid == '4':
        pid = '3.304tv'
    u"修正2.203商务"
    bcloud_tags = ['100172', '100001', '100132', '100349', '100388', '100008',
    ...
    if '/ver_' in purlparseobj.path and (not pid.startswith('2.203b')):
        pid = pid + '_new'
    ...
    business = pid
    http_code, contlength, loadtime, other = u_1[0].strip().strip('\"').split('\" ')[1].split('http')[0].split()
    ...
    if business.startswith('102.'):
        ...
        bcloud_line = None
    return (rstline_ , converted, ptime, userip, logtype, slowspeed_line, bcloud_line)


if __name__ == "__main__":
    for line in sys.stdin:
        print line
        print slowspeed(line)[1]
        print slowspeed(line)
